...
- scss 이거 잘 이해가 안 되는데, 꼭 배워야 할 것 같아. 그리고, 컴포넌트에 담는 css 를 잘 할 수 있어야 -> scss 에 담을 수 있어 ⭐⭐⭐⭐⭐⭐⭐⭐ 
...
### 그러면, 날씨에 따라서, 다양한 애니메이션들이 나오게 하는 것도 가능하겠네? ⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐ 

모쪼록, 나는 3d, 2d 움직임, 애니메이션으로 표현하고 싶어함. 



- 날씨 api 정보 

![](https://i.imgur.com/NKpvZtn.png)


- API 키 발급 

![](https://i.imgur.com/IbE0j8W.png)

![](https://i.imgur.com/GjRiXpI.png)
...
- 다시 
```
1. 이건 고차 함수임 > 따라서, 2번 실행이 되어야, 최종 결과값이 나옴 
...
[[scss 관련]]
[[빌드 npm run build 주의할 점 ]]
[[미들웨어 thunk 사용방법 및 기능 이해]]

[[고차함수, dispatch 의 2가지 기능, thunk 를 쓰는 이유, 결국 이벤트 루프, 즉 비동기 처리 ]]

[[오늘 포인트 중 하나 _combineReducers]]
